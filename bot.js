...
//Podesavanja
const host                = "79.133.61.6";
const port                = 10230;
const queryport           = 210071;
const username            = "Strażnik 666";
const password            = "";
const botname             = "Strażnik 666";
...
const botprefix           = ".";
const OnlineChannelID     = 1130431;
const StaffChannelID      = 1130432;
const HelpChannelID       = 1130433;
const StaffGroups         = ["74"];
const NotifyHelp          = ["45"];
